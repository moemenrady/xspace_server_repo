...
class BookingsAnalyticsController extends Controller
{
    protected $svc;
    public function __construct(BookingsAnalyticsController $svc){
        $this->svc = $svc;
    }
    ...
    public function index(Request $request){
        ...
        return view('admin.analytics.bookings', compact('summary','trends'));
    }
