...
class SessionsAnalyticsController extends Controller
{
    protected $svc;
    public function __construct(SessionsAnalyticsController $svc){
        $this->svc = $svc;
    }
    ...
    public function index(Request $request){
        ...
        return view('admin.analytics.sessions', compact('summary','trends'));
    }
