...
class SubscriptionsAnalyticsController extends Controller
{
    protected $svc;
    public function __construct(SubscriptionsAnalyticsController $svc){
        $this->svc = $svc;
    }
    ...
    public function index(Request $request){
        ...
        return view('admin.analytics.subscriptions', compact('summary','trends'));
    }
